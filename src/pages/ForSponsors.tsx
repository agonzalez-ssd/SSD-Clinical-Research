  ...
  return (
    <Layout>
      <SEO
        ...
        description="Partner with Southern Skies Research for dermatology clinical trials in Alabama. 50k+ patient database, board-certified PIs, 4 locations, HIPAA-compliant infrastructure."
          ...
          <div className="flex-1 relative">
            ...
            <div className="absolute -bottom-6 -left-6 md:-left-12 bg-surface-container-lowest p-8 rounded-xl shadow-xl border border-outline-variant/10 max-w-xs">
              <div className="space-y-6">
                ...
                <div className="h-px bg-outline-variant/20" />
                <div>
                  <div className="text-3xl font-bold font-headline text-primary">4 Site</div>
          ...
          <div className="lg:w-1/2">
            ...
            <div className="space-y-6">
              {[
                ...
                { label: "Diverse Demographics Across Alabama", value: "4 Locations" },
          ...
          <div className="lg:w-1/2 w-full">
            <div className="bg-surface-container-low rounded-2xl p-8 border border-outline-variant/10">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-surface-container-lowest p-6 rounded-xl text-center">
                  <div className="text-4xl font-headline font-extrabold text-primary mb-1">4/4</div>
